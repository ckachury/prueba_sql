...
/
--------------------------------------------------------
--  DDL for Sequence IDACURSO
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."IDACURSO"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 ORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence IDAPRUEBA
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."IDAPRUEBA"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 ORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence IDATEST
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."IDATEST"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 ORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table CURSO_ALUMNO
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."CURSO_ALUMNO" 
   (	"ALUMNO_RUT_ALUMNO" VARCHAR2(11 CHAR), 
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table CURSO_PRUEBA
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."CURSO_PRUEBA" 
   (	"CURSO_ID_CURSO" NUMBER(*,0), 
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table CURSO_TEST
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."CURSO_TEST" 
   (	"CURSO_ID_CURSO" NUMBER(*,0), 
	"TEST_ID_TEST" NUMBER(*,0)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."INVENTORIES" 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."OPCION" 
   (	"ID_ALT" NUMBER(*,0), 
	"NOMBRE_ALT" VARCHAR2(2 BYTE), 
	"PORCENTAJE" NUMBER(*,0), 
	"PREGUNTA_ID_PREG" NUMBER(*,0), 
	"ES_CORRECTO" NUMBER(*,0)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table OPCION_RESP
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."OPCION_RESP" 
   (	"OPCION_ID_ALT" NUMBER(*,0), 
	"RESP_ID_RESP" NUMBER(*,0)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."PREGUNTA" 
   (	"ID_PREG" NUMBER(*,0), 
	"ENUNCIADO" VARCHAR2(255 CHAR), 
	"PUNTAJE" NUMBER(5,2), 
	"PRUEBA_ID_TEST" NUMBER(*,0)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."RESP" 
   (	"ID_RESP" NUMBER(*,0), 
	"PUNT_ALUMNO" NUMBER(7,2), 
	"PUNT_NORM" NUMBER(2,1), 
	"ALUMNO_RUT_ALUMNO" VARCHAR2(11 CHAR), 
	"RESP_CORREG" NUMBER(*,0), 
	"RESPUESTA_ALUMNO" VARCHAR2(1 BYTE)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
SET DEFINE OFF;
Insert into SYSTEM.ALUMNO (RUT_ALUMNO,NOMBRE) values ('7333919-7','Yorbeli Santo Pedrera');
Insert into SYSTEM.ALUMNO (RUT_ALUMNO,NOMBRE) values ('14654485-1','Simeón Cernadas Monterinos');
Insert into SYSTEM.ALUMNO (RUT_ALUMNO,NOMBRE) values ('23747643-3','Edmundo Cullar Domingo');
Insert into SYSTEM.ALUMNO (RUT_ALUMNO,NOMBRE) values ('8927869-4','Leoncio Mascire Pineda');
Insert into SYSTEM.ALUMNO (RUT_ALUMNO,NOMBRE) values ('20457649-1','Inmaculada Ibisate Maliaño');
Insert into SYSTEM.ALUMNO (RUT_ALUMNO,NOMBRE) values ('21902099-6','Graciela Valderrama Cambero');
Insert into SYSTEM.ALUMNO (RUT_ALUMNO,NOMBRE) values ('19432987-3','Rigel Aguileta Malvido');
Insert into SYSTEM.ALUMNO (RUT_ALUMNO,NOMBRE) values ('12736373-0','Nohely Casasola Alzaga');
Insert into SYSTEM.ALUMNO (RUT_ALUMNO,NOMBRE) values ('8820576-6','Armonia Cicero Masas');
Insert into SYSTEM.ALUMNO (RUT_ALUMNO,NOMBRE) values ('12649741-5','Wilson Domingo Romo');
Insert into SYSTEM.ALUMNO (RUT_ALUMNO,NOMBRE) values ('19031515-0','Alec Palmadas Echaitia');
Insert into SYSTEM.ALUMNO (RUT_ALUMNO,NOMBRE) values ('13030793-0','Berenice Cotero Azuela');
Insert into SYSTEM.ALUMNO (RUT_ALUMNO,NOMBRE) values ('20551341-8','Irmin Robina Rubinos');
Insert into SYSTEM.ALUMNO (RUT_ALUMNO,NOMBRE) values ('11006625-2','Antolín Horcasitas Urbieta');
Insert into SYSTEM.ALUMNO (RUT_ALUMNO,NOMBRE) values ('23586575-0','Filiberta Mancina Andrada');
Insert into SYSTEM.ALUMNO (RUT_ALUMNO,NOMBRE) values ('24773918-1','Francisco Vadillos Temporal');
Insert into SYSTEM.ALUMNO (RUT_ALUMNO,NOMBRE) values ('14526647-5','Marcos Cigüenza Toro');
Insert into SYSTEM.ALUMNO (RUT_ALUMNO,NOMBRE) values ('22659582-1','Leida Brugos Pareja');
Insert into SYSTEM.ALUMNO (RUT_ALUMNO,NOMBRE) values ('15030663-9','Jonás Ferreiro Quijana');
Insert into SYSTEM.ALUMNO (RUT_ALUMNO,NOMBRE) values ('17044365-9','Luis Alberto Pérez Blanco');
...
SET DEFINE OFF;
Insert into SYSTEM.CURSO (ID_CURSO,NOMBRE) values ('1','Fullstack Java Developer');
Insert into SYSTEM.CURSO (ID_CURSO,NOMBRE) values ('2','Fullstack Java Developer');
Insert into SYSTEM.CURSO (ID_CURSO,NOMBRE) values ('3','Android Developer');
Insert into SYSTEM.CURSO (ID_CURSO,NOMBRE) values ('4','Frontend Developer');
REM INSERTING into SYSTEM.CURSO_ALUMNO
SET DEFINE OFF;
Insert into SYSTEM.CURSO_ALUMNO (ALUMNO_RUT_ALUMNO,CURSO_ID_CURSO) values ('11006625-2','2');
Insert into SYSTEM.CURSO_ALUMNO (ALUMNO_RUT_ALUMNO,CURSO_ID_CURSO) values ('12649741-5','2');
Insert into SYSTEM.CURSO_ALUMNO (ALUMNO_RUT_ALUMNO,CURSO_ID_CURSO) values ('12736373-0','1');
Insert into SYSTEM.CURSO_ALUMNO (ALUMNO_RUT_ALUMNO,CURSO_ID_CURSO) values ('13030793-0','2');
Insert into SYSTEM.CURSO_ALUMNO (ALUMNO_RUT_ALUMNO,CURSO_ID_CURSO) values ('14526647-5','2');
Insert into SYSTEM.CURSO_ALUMNO (ALUMNO_RUT_ALUMNO,CURSO_ID_CURSO) values ('14654485-1','1');
Insert into SYSTEM.CURSO_ALUMNO (ALUMNO_RUT_ALUMNO,CURSO_ID_CURSO) values ('15030663-9','2');
Insert into SYSTEM.CURSO_ALUMNO (ALUMNO_RUT_ALUMNO,CURSO_ID_CURSO) values ('17044365-9','1');
Insert into SYSTEM.CURSO_ALUMNO (ALUMNO_RUT_ALUMNO,CURSO_ID_CURSO) values ('19031515-0','2');
Insert into SYSTEM.CURSO_ALUMNO (ALUMNO_RUT_ALUMNO,CURSO_ID_CURSO) values ('19432987-3','1');
Insert into SYSTEM.CURSO_ALUMNO (ALUMNO_RUT_ALUMNO,CURSO_ID_CURSO) values ('20457649-1','1');
Insert into SYSTEM.CURSO_ALUMNO (ALUMNO_RUT_ALUMNO,CURSO_ID_CURSO) values ('20551341-8','2');
Insert into SYSTEM.CURSO_ALUMNO (ALUMNO_RUT_ALUMNO,CURSO_ID_CURSO) values ('21902099-6','1');
Insert into SYSTEM.CURSO_ALUMNO (ALUMNO_RUT_ALUMNO,CURSO_ID_CURSO) values ('22659582-1','2');
Insert into SYSTEM.CURSO_ALUMNO (ALUMNO_RUT_ALUMNO,CURSO_ID_CURSO) values ('23586575-0','2');
Insert into SYSTEM.CURSO_ALUMNO (ALUMNO_RUT_ALUMNO,CURSO_ID_CURSO) values ('23747643-3','1');
Insert into SYSTEM.CURSO_ALUMNO (ALUMNO_RUT_ALUMNO,CURSO_ID_CURSO) values ('24773918-1','2');
Insert into SYSTEM.CURSO_ALUMNO (ALUMNO_RUT_ALUMNO,CURSO_ID_CURSO) values ('7333919-7','1');
Insert into SYSTEM.CURSO_ALUMNO (ALUMNO_RUT_ALUMNO,CURSO_ID_CURSO) values ('8820576-6','1');
Insert into SYSTEM.CURSO_ALUMNO (ALUMNO_RUT_ALUMNO,CURSO_ID_CURSO) values ('8927869-4','1');
REM INSERTING into SYSTEM.CURSO_PRUEBA
SET DEFINE OFF;
REM INSERTING into SYSTEM.CURSO_TEST
SET DEFINE OFF;
...
SET DEFINE OFF;
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('107','Summer','Payne','summer.payne@example.com','515.123.8181',to_date('07/06/16','DD/MM/RR'),'106','Public Accountant');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('106','Rose','Stephens','rose.stephens@example.com','515.123.8080',to_date('07/06/16','DD/MM/RR'),'2','Accounting Manager');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('101','Annabelle','Dunn','annabelle.dunn@example.com','515.123.4444',to_date('17/09/16','DD/MM/RR'),'2','Administration Assistant');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('1','Tommy','Bailey','tommy.bailey@example.com','515.123.4567',to_date('17/06/16','DD/MM/RR'),null,'President');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('3','Blake','Cooper','blake.cooper@example.com','515.123.4569',to_date('13/01/16','DD/MM/RR'),'1','Administration Vice President');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('2','Jude','Rivera','jude.rivera@example.com','515.123.4568',to_date('21/09/16','DD/MM/RR'),'1','Administration Vice President');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('11','Tyler','Ramirez','tyler.ramirez@example.com','515.124.4269',to_date('28/09/16','DD/MM/RR'),'9','Accountant');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('12','Elliott','James','elliott.james@example.com','515.124.4369',to_date('30/09/16','DD/MM/RR'),'9','Accountant');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('13','Albert','Watson','albert.watson@example.com','515.124.4469',to_date('07/03/16','DD/MM/RR'),'9','Accountant');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('104','Harper','Spencer','harper.spencer@example.com','515.123.7777',to_date('07/06/16','DD/MM/RR'),'2','Human Resources Representative');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('4','Louie','Richardson','louie.richardson@example.com','590.423.4567',to_date('03/01/16','DD/MM/RR'),'3','Programmer');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('5','Nathan','Cox','nathan.cox@example.com','590.423.4568',to_date('21/05/16','DD/MM/RR'),'4','Programmer');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('8','Bobby','Torres','bobby.torres@example.com','590.423.5567',to_date('07/02/16','DD/MM/RR'),'4','Programmer');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('7','Charles','Ward','charles.ward@example.com','590.423.4560',to_date('05/02/16','DD/MM/RR'),'4','Programmer');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('6','G04iel','Howard','g04iel.howard@example.com','590.423.4569',to_date('25/06/16','DD/MM/RR'),'4','Programmer');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('102','Emma','Perkins','emma.perkins@example.com','515.123.5555',to_date('17/02/16','DD/MM/RR'),'1','03keting Manager');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('105','Gracie','Gardner','gracie.gardner@example.com','515.123.8888',to_date('07/06/16','DD/MM/RR'),'2','Public Relations Representative');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('16','Alex','Sanders','alex.sanders@example.com','515.127.4562',to_date('18/05/16','DD/MM/RR'),'15','Purchasing Clerk');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('18','Ollie','Bennett','ollie.bennett@example.com','515.127.4564',to_date('24/07/16','DD/MM/RR'),'15','Purchasing Clerk');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('19','Louis','Wood','louis.wood@example.com','515.127.4565',to_date('15/11/16','DD/MM/RR'),'15','Purchasing Clerk');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('49','Isabella','Cole','isabella.cole@example.com','011.44.1344.619268',to_date('15/10/16','DD/MM/RR'),'1','Sales Manager');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('48','Jessica','Woods','jessica.woods@example.com','011.44.1344.429278',to_date('10/03/16','DD/MM/RR'),'1','Sales Manager');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('47','Ella','Wallace','ella.wallace@example.com','011.44.1344.467268',to_date('05/01/16','DD/MM/RR'),'1','Sales Manager');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('46','Ava','Sullivan','ava.sullivan@example.com','011.44.1344.429268',to_date('01/10/16','DD/MM/RR'),'1','Sales Manager');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('50','Mia','West','mia.west@example.com','011.44.1344.429018',to_date('29/01/16','DD/MM/RR'),'1','Sales Manager');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('56','Evie','Harrison','evie.harrison@example.com','011.44.1344.486508',to_date('23/11/16','DD/MM/RR'),'46','Sales Representative');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('57','Scarlett','Gibson','scarlett.gibson@example.com','011.44.1345.429268',to_date('30/01/16','DD/MM/RR'),'47','Sales Representative');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('58','Ruby','Mcdonald','ruby.mcdonald@example.com','011.44.1345.929268',to_date('04/03/16','DD/MM/RR'),'47','Sales Representative');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('60','Isabelle','03shall','isabelle.03shall@example.com','011.44.1345.729268',to_date('10/03/16','DD/MM/RR'),'47','Sales Representative');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('62','Freya','Gomez','freya.gomez@example.com','011.44.1345.529268',to_date('03/11/16','DD/MM/RR'),'47','Sales Representative');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('80','Elizabeth','Dixon','elizabeth.dixon@example.com','011.44.1644.429262',to_date('04/01/16','DD/MM/RR'),'50','Sales Representative');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('64','Florence','Freeman','florence.freeman@example.com','011.44.1346.229268',to_date('19/03/16','DD/MM/RR'),'48','Sales Representative');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('65','Alice','Wells','alice.wells@example.com','011.44.1346.329268',to_date('24/01/16','DD/MM/RR'),'48','Sales Representative');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('66','Charlotte','Webb','charlotte.webb@example.com','011.44.1346.529268',to_date('23/02/16','DD/MM/RR'),'48','Sales Representative');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('67','Sienna','Simpson','sienna.simpson@example.com','011.44.1346.629268',to_date('24/03/16','DD/MM/RR'),'48','Sales Representative');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('69','Evelyn','Tucker','evelyn.tucker@example.com','011.44.1343.929268',to_date('11/03/16','DD/MM/RR'),'49','Sales Representative');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('70','Eva','Porter','eva.porter@example.com','011.44.1343.829268',to_date('23/03/16','DD/MM/RR'),'49','Sales Representative');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('71','Millie','Hunter','millie.hunter@example.com','011.44.1343.729268',to_date('24/01/16','DD/MM/RR'),'49','Sales Representative');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('72','Sofia','Hicks','sofia.hicks@example.com','011.44.1343.629268',to_date('23/02/16','DD/MM/RR'),'49','Sales Representative');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('73','Lucy','Crawford','lucy.crawford@example.com','011.44.1343.529268',to_date('24/03/16','DD/MM/RR'),'49','Sales Representative');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('75','Imogen','Boyd','imogen.boyd@example.com','011.44.1644.429267',to_date('11/05/16','DD/MM/RR'),'50','Sales Representative');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('76','Layla','Mason','layla.mason@example.com','011.44.1644.429266',to_date('19/03/16','DD/MM/RR'),'50','Sales Representative');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('77','Rosie','Morales','rosie.morales@example.com','011.44.1644.429265',to_date('24/03/16','DD/MM/RR'),'50','Sales Representative');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('79','Esme','Warren','esme.warren@example.com','011.44.1644.429263',to_date('24/05/16','DD/MM/RR'),'50','Sales Representative');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('54','Lily','Fisher','lily.fisher@example.com','011.44.1344.498718',to_date('30/03/16','DD/MM/RR'),'46','Sales Representative');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('52','Sophie','Owens','sophie.owens@example.com','011.44.1344.345268',to_date('24/03/16','DD/MM/RR'),'46','Sales Representative');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('51','Poppy','Jordan','poppy.jordan@example.com','011.44.1344.129268',to_date('30/01/16','DD/MM/RR'),'46','Sales Representative');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('63','Phoebe','Murray','phoebe.murray@example.com','011.44.1346.129268',to_date('11/11/16','DD/MM/RR'),'48','Sales Representative');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('85','Holly','Shaw','holly.shaw@example.com','650.509.1876',to_date('27/01/16','DD/MM/RR'),'22','Shipping Clerk');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('86','Emilia','Holmes','emilia.holmes@example.com','650.509.2876',to_date('20/02/16','DD/MM/RR'),'22','Shipping Clerk');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('87','Molly','Rice','molly.rice@example.com','650.509.3876',to_date('24/06/16','DD/MM/RR'),'22','Shipping Clerk');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('88','Ellie','Robertson','ellie.robertson@example.com','650.509.4876',to_date('07/02/16','DD/MM/RR'),'22','Shipping Clerk');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('89','Jasmine','Hunt','jasmine.hunt@example.com','650.505.1876',to_date('14/06/16','DD/MM/RR'),'23','Shipping Clerk');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('91','Lilly','Daniels','lilly.daniels@example.com','650.505.3876',to_date('11/07/16','DD/MM/RR'),'23','Shipping Clerk');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('93','Georgia','Mills','georgia.mills@example.com','650.501.1876',to_date('04/02/16','DD/MM/RR'),'24','Shipping Clerk');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('94','Maisie','Nichols','maisie.nichols@example.com','650.501.2876',to_date('03/03/16','DD/MM/RR'),'24','Shipping Clerk');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('95','Eleanor','Grant','eleanor.grant@example.com','650.501.3876',to_date('01/07/16','DD/MM/RR'),'24','Shipping Clerk');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('96','Hannah','Knight','hannah.knight@example.com','650.501.4876',to_date('17/03/16','DD/MM/RR'),'24','Shipping Clerk');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('98','Amber','Rose','amber.rose@example.com','650.507.9822',to_date('23/05/16','DD/MM/RR'),'25','Shipping Clerk');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('99','Bella','Stone','bella.stone@example.com','650.507.9833',to_date('21/06/16','DD/MM/RR'),'25','Shipping Clerk');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('100','Thea','Hawkins','thea.hawkins@example.com','650.507.9844',to_date('13/01/16','DD/MM/RR'),'25','Shipping Clerk');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('81','Lola','Ramos','lola.ramos@example.com','650.507.9876',to_date('24/01/16','DD/MM/RR'),'21','Shipping Clerk');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('82','Willow','Reyes','willow.reyes@example.com','650.507.9877',to_date('23/02/16','DD/MM/RR'),'21','Shipping Clerk');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('83','Ivy','Burns','ivy.burns@example.com','650.507.9878',to_date('21/06/16','DD/MM/RR'),'21','Shipping Clerk');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('84','Erin','Gordon','erin.gordon@example.com','650.507.9879',to_date('03/02/16','DD/MM/RR'),'21','Shipping Clerk');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('44','Emily','Hamilton','emily.hamilton@example.com','650.121.2874',to_date('15/03/16','DD/MM/RR'),'25','Stock Clerk');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('43','Olivia','Ford','olivia.ford@example.com','650.121.2994',to_date('29/01/16','DD/MM/RR'),'25','Stock Clerk');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('42','Amelia','Myers','amelia.myers@example.com','650.121.8009',to_date('17/10/16','DD/MM/RR'),'25','Stock Clerk');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('26','Leon','Powell','leon.powell@example.com','650.124.1214',to_date('16/07/16','DD/MM/RR'),'21','Stock Clerk');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('27','Kai','Long','kai.long@example.com','650.124.1224',to_date('28/09/16','DD/MM/RR'),'21','Stock Clerk');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('28','Aaron','Patterson','aaron.patterson@example.com','650.124.1334',to_date('14/01/16','DD/MM/RR'),'21','Stock Clerk');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('29','Roman','Hughes','roman.hughes@example.com','650.124.1434',to_date('08/03/16','DD/MM/RR'),'21','Stock Clerk');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('31','Ellis','Washington','ellis.washington@example.com','650.124.6234',to_date('30/10/16','DD/MM/RR'),'22','Stock Clerk');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('32','Jamie','Butler','jamie.butler@example.com','650.124.7234',to_date('16/02/16','DD/MM/RR'),'22','Stock Clerk');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('45','Isla','Graham','isla.graham@example.com','650.121.2004',to_date('09/07/16','DD/MM/RR'),'25','Stock Clerk');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('34','Seth','Foster','seth.foster@example.com','650.127.1934',to_date('14/06/16','DD/MM/RR'),'23','Stock Clerk');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('37','Ibrahim','Alexander','ibrahim.alexander@example.com','650.127.1634',to_date('06/02/16','DD/MM/RR'),'23','Stock Clerk');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('38','Sonny','Russell','sonny.russell@example.com','650.121.1234',to_date('14/07/16','DD/MM/RR'),'24','Stock Clerk');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('39','Kian','Griffin','kian.griffin@example.com','650.121.2034',to_date('26/10/16','DD/MM/RR'),'24','Stock Clerk');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('40','Caleb','Diaz','caleb.diaz@example.com','650.121.2019',to_date('12/02/16','DD/MM/RR'),'24','Stock Clerk');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('25','Ronnie','Perry','ronnie.perry@example.com','650.123.5234',to_date('16/11/16','DD/MM/RR'),'1','Stock Manager');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('24','Callum','Jenkins','callum.jenkins@example.com','650.123.4234',to_date('10/10/16','DD/MM/RR'),'1','Stock Manager');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('23','Jackson','Coleman','jackson.coleman@example.com','650.123.3234',to_date('01/05/16','DD/MM/RR'),'1','Stock Manager');
Insert into SYSTEM.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE,HIRE_DATE,MANAGER_ID,JOB_TITLE) values ('21','Jaxon','Ross','jaxon.ross@example.com','650.123.1234',to_date('18/07/16','DD/MM/RR'),'1','Stock Manager');
...
REM INSERTING into SYSTEM.INVENTORIES
SET DEFINE OFF;
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.OPCION
SET DEFINE OFF;
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('1','a','20','1','1');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('2','b','0','1','0');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('3','c','0','1','0');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('4','d','80','1','1');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('5','a','50','2','1');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('6','b','50','2','1');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('7','c','0','2','0');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('8','d','0','2','0');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('9','a','0','3','0');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('10','b','0','3','0');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('11','c','40','3','1');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('12','d','60','3','1');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('13','a','50','4','1');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('14','b','0','4','0');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('15','c','50','4','1');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('16','d','0','4','0');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('17','a','30','5','1');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('18','b','70','5','1');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('19','c','0','5','0');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('20','d','0','5','0');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('21','a','0','6','0');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('22','b','0','6','0');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('23','c','50','6','1');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('24','d','50','6','1');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('25','a','0','7','0');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('26','b','25','7','1');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('27','c','0','7','0');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('28','d','75','7','1');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('29','a','50','8','1');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('30','b','50','8','1');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('31','c','0','8','0');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('32','d','0','8','0');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('33','a','50','9','1');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('34','b','50','9','1');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('35','c','0','9','0');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('36','d','0','9','0');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('37','a','0','10','0');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('38','b','60','10','1');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('39','c','0','10','0');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('40','d','40','10','1');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('41','a','20','11','1');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('42','b','0','11','0');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('43','c','0','11','0');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('44','d','80','11','1');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('45','a','50','12','1');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('46','b','50','12','1');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('47','c','0','12','0');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('48','d','0','12','0');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('49','a','0','13','0');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('50','b','0','13','0');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('51','c','40','13','1');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('52','d','60','13','1');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('53','a','50','14','1');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('54','b','0','14','0');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('55','c','50','14','1');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('56','d','0','14','0');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('57','a','30','15','1');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('58','b','70','15','1');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('59','c','0','15','0');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('60','d','0','15','0');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('61','a','0','16','0');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('62','b','0','16','0');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('63','c','50','16','1');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('64','d','50','16','1');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('65','a','0','17','0');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('66','b','25','17','1');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('67','c','0','17','0');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('68','d','75','17','1');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('69','a','50','18','1');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('70','b','50','18','1');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('71','c','0','18','0');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('72','d','0','18','0');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('73','a','50','19','1');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('74','b','50','19','1');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('75','c','0','19','0');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('76','d','0','19','0');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('77','a','0','20','0');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('78','b','60','20','1');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('79','c','0','20','0');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('80','d','40','20','1');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('81','a','50','21','1');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('82','b','0','21','0');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('83','a','50','22','1');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('84','b','0','22','0');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('85','a','25','23','1');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('86','b','25','23','1');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('87','c','25','23','1');
Insert into SYSTEM.OPCION (ID_ALT,NOMBRE_ALT,PORCENTAJE,PREGUNTA_ID_PREG,ES_CORRECTO) values ('88','d','25','23','1');
REM INSERTING into SYSTEM.OPCION_RESP
SET DEFINE OFF;
REM INSERTING into SYSTEM.ORDER_ITEMS
SET DEFINE OFF;
REM INSERTING into SYSTEM.ORDERS
SET DEFINE OFF;
REM INSERTING into SYSTEM.PREGUNTA
SET DEFINE OFF;
Insert into SYSTEM.PREGUNTA (ID_PREG,ENUNCIADO,PUNTAJE,PRUEBA_ID_TEST) values ('1','Un archivo o conjunto de archivos que contienen múltiples informaciones que, de alguna forma, guardan relación es','10','3');
Insert into SYSTEM.PREGUNTA (ID_PREG,ENUNCIADO,PUNTAJE,PRUEBA_ID_TEST) values ('2','La herramienta informática que permite crear, manipular, gestionar y eliminar los datos y las estructuras de una base de datos es','5','3');
Insert into SYSTEM.PREGUNTA (ID_PREG,ENUNCIADO,PUNTAJE,PRUEBA_ID_TEST) values ('3','De los siguientes acrónimos, indica cual es un Sistema Gestor de Bases de Datos (SGBD)','5','3');
Insert into SYSTEM.PREGUNTA (ID_PREG,ENUNCIADO,PUNTAJE,PRUEBA_ID_TEST) values ('4','Las fases del diseño de una base de datos relacional son:','10','3');
Insert into SYSTEM.PREGUNTA (ID_PREG,ENUNCIADO,PUNTAJE,PRUEBA_ID_TEST) values ('5','De las siguientes afirmaciones, indica cuales son ciertas respecto a una base de datos relacional','10','3');
Insert into SYSTEM.PREGUNTA (ID_PREG,ENUNCIADO,PUNTAJE,PRUEBA_ID_TEST) values ('6','La clave (o llave) primaria (o principal) en una tabla de una base de datos relacional','10','3');
Insert into SYSTEM.PREGUNTA (ID_PREG,ENUNCIADO,PUNTAJE,PRUEBA_ID_TEST) values ('7','Los filtros en las aplicaciones informáticas para bases de datos, permite','10','3');
Insert into SYSTEM.PREGUNTA (ID_PREG,ENUNCIADO,PUNTAJE,PRUEBA_ID_TEST) values ('8','Una consulta en una base de datos es …','15','3');
Insert into SYSTEM.PREGUNTA (ID_PREG,ENUNCIADO,PUNTAJE,PRUEBA_ID_TEST) values ('9','Las tablas de una bases de datos relacional han de tener cada una un campo que permita identificar unívocamente cada registro','15','3');
Insert into SYSTEM.PREGUNTA (ID_PREG,ENUNCIADO,PUNTAJE,PRUEBA_ID_TEST) values ('10','En una consulta de selección en una aplicación para bases de datos, ¿cuándo se obtendrán como resultado más registros: cuando unimos los criterios mediante “y” o cuando los unimos mediante “o”?','10','3');
Insert into SYSTEM.PREGUNTA (ID_PREG,ENUNCIADO,PUNTAJE,PRUEBA_ID_TEST) values ('11','Un bucle o ciclo es','10','2');
Insert into SYSTEM.PREGUNTA (ID_PREG,ENUNCIADO,PUNTAJE,PRUEBA_ID_TEST) values ('12','if, else, for y while son','10','2');
Insert into SYSTEM.PREGUNTA (ID_PREG,ENUNCIADO,PUNTAJE,PRUEBA_ID_TEST) values ('13','La programación se puede definir como...','5','2');
Insert into SYSTEM.PREGUNTA (ID_PREG,ENUNCIADO,PUNTAJE,PRUEBA_ID_TEST) values ('14','¿Qué es un algoritmo?','5','2');
Insert into SYSTEM.PREGUNTA (ID_PREG,ENUNCIADO,PUNTAJE,PRUEBA_ID_TEST) values ('15','¿Cuándo se mostrará por pantalla el mensaje incluido en el siguiente fragmento de código? If (numero % 2 == 0); System.out.print("El número es par /n");','10','2');
Insert into SYSTEM.PREGUNTA (ID_PREG,ENUNCIADO,PUNTAJE,PRUEBA_ID_TEST) values ('16','¿Qué es necesario incluir en cada conjunto de sentencias asociadas a los posibles valores que pueden tomarse en un switch? ','15','2');
Insert into SYSTEM.PREGUNTA (ID_PREG,ENUNCIADO,PUNTAJE,PRUEBA_ID_TEST) values ('17','Si sabemos exactamente cuántas iteraciones vamos a realizar, ¿qué tipo de bucle debemos utilizar?','10','2');
Insert into SYSTEM.PREGUNTA (ID_PREG,ENUNCIADO,PUNTAJE,PRUEBA_ID_TEST) values ('18','¿Cuál de las siguientes no es una estructura de selección?','10','2');
Insert into SYSTEM.PREGUNTA (ID_PREG,ENUNCIADO,PUNTAJE,PRUEBA_ID_TEST) values ('19','int, char, float, string y boolean son','5','2');
Insert into SYSTEM.PREGUNTA (ID_PREG,ENUNCIADO,PUNTAJE,PRUEBA_ID_TEST) values ('20','A un tipo de sentencia especial de decisión y una secuencia de instrucciones que pueden ser repetidas según el resultado de la evaluación de la sentencia de decisión, se le denomina','20','2');
Insert into SYSTEM.PREGUNTA (ID_PREG,ENUNCIADO,PUNTAJE,PRUEBA_ID_TEST) values ('21','pregunta 1','10','4');
Insert into SYSTEM.PREGUNTA (ID_PREG,ENUNCIADO,PUNTAJE,PRUEBA_ID_TEST) values ('22','pregunta2','50','4');
Insert into SYSTEM.PREGUNTA (ID_PREG,ENUNCIADO,PUNTAJE,PRUEBA_ID_TEST) values ('23','pregunta 3 error','25','5');
REM INSERTING into SYSTEM.PRODUCT_CATEGORIES
SET DEFINE OFF;
REM INSERTING into SYSTEM.PRODUCTS
SET DEFINE OFF;
REM INSERTING into SYSTEM.PRUEBA
SET DEFINE OFF;
Insert into SYSTEM.PRUEBA (ID_TEST,NOMBRE,DESCRIPCION,PROGRAMA,UNIDAD,AUTOR,FECHA_CREACION,CURSO_ID_CURSO) values ('1','Conceptos de POO','Evaluar conceptos de POO','Fullstack developer','2','Brian',to_date('13/02/20','DD/MM/RR'),'2');
Insert into SYSTEM.PRUEBA (ID_TEST,NOMBRE,DESCRIPCION,PROGRAMA,UNIDAD,AUTOR,FECHA_CREACION,CURSO_ID_CURSO) values ('2','Bases de datos relacionales','Evauar conceptos de bases de datos relacionales','Fullstack developer','1','Rodrigo',to_date('10/03/20','DD/MM/RR'),'1');
Insert into SYSTEM.PRUEBA (ID_TEST,NOMBRE,DESCRIPCION,PROGRAMA,UNIDAD,AUTOR,FECHA_CREACION,CURSO_ID_CURSO) values ('3','Bucles y Condicionales','Evaluar bucles y condicionales','Fullstack developer','1','Rodrigo',to_date('30/01/20','DD/MM/RR'),'1');
Insert into SYSTEM.PRUEBA (ID_TEST,NOMBRE,DESCRIPCION,PROGRAMA,UNIDAD,AUTOR,FECHA_CREACION,CURSO_ID_CURSO) values ('4','Tests automatizados de app móviles','Diseño de pruebas automatizadas','Android developer','3','Felipe',to_date('20/03/20','DD/MM/RR'),'3');
Insert into SYSTEM.PRUEBA (ID_TEST,NOMBRE,DESCRIPCION,PROGRAMA,UNIDAD,AUTOR,FECHA_CREACION,CURSO_ID_CURSO) values ('5','Codificación para Android','Evaluar la sintaxis en la codificacion de apps Android','Android developer','2','Felipe',to_date('20/02/20','DD/MM/RR'),'3');
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.RESP
SET DEFINE OFF;
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('1','2',null,'12736373-0','1','a');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('2','8',null,'12736373-0','1','d');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('3','0',null,'12736373-0','0','c');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('4','0',null,'12736373-0','0','c');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('5','2',null,'12736373-0','1','c');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('6','3',null,'12736373-0','1','d');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('7','5',null,'12736373-0','1','a');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('8','5',null,'12736373-0','1','c');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('9','0',null,'12736373-0','0','c');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('10','0',null,'12736373-0','0','d');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('11','0',null,'12736373-0','0','a');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('12','0',null,'12736373-0','0','a');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('13','7,5',null,'12736373-0','1','b');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('14','7,5',null,'12736373-0','1','d');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('15','7,5',null,'12736373-0','1','a');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('16','7,5',null,'12736373-0','1','b');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('17','0',null,'12736373-0','0','c');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('18','0',null,'12736373-0','0','c');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('19','0',null,'12736373-0','0','a');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('20','0',null,'12736373-0','0','c');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('21','2',null,'14654485-1','1','a');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('22','8',null,'14654485-1','1','d');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('23','2,5',null,'14654485-1','1','a');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('24','2,5',null,'14654485-1','1','b');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('25','2',null,'14654485-1','1','c');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('26','3',null,'14654485-1','1','d');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('27','0',null,'14654485-1','0','c');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('28','0',null,'14654485-1','0','b');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('29','0',null,'14654485-1','0','c');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('30','0',null,'14654485-1','0','c');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('31','5',null,'14654485-1','1','c');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('32','5',null,'14654485-1','1','d');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('33','7,5',null,'14654485-1','1','b');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('34','0',null,'14654485-1','0','a');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('35','0',null,'14654485-1','0','d');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('36','0',null,'14654485-1','0','d');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('37','0',null,'14654485-1','0','d');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('38','0',null,'14654485-1','0','c');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('39','6',null,'14654485-1','1','b');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('40','4',null,'14654485-1','1','d');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('41','2',null,'17044365-9','1','a');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('42','8',null,'17044365-9','1','d');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('43','2,5',null,'17044365-9','1','a');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('44','2,5',null,'17044365-9','1','b');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('45','0',null,'17044365-9','0','d');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('46','0',null,'17044365-9','0','a');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('47','0',null,'17044365-9','0','b');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('48','0',null,'17044365-9','0','b');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('49','0',null,'17044365-9','0','d');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('50','7',null,'17044365-9','1','b');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('51','5',null,'17044365-9','1','c');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('52','5',null,'17044365-9','1','d');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('53','7,5',null,'17044365-9','1','b');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('54','7,5',null,'17044365-9','1','d');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('55','7,5',null,'17044365-9','1','a');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('56','7,5',null,'17044365-9','1','b');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('57','7,5',null,'17044365-9','1','a');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('58','7,5',null,'17044365-9','1','b');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('59','0',null,'17044365-9','0','c');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('60','0',null,'17044365-9','0','c');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('61','0',null,'19432987-3','0','c');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('62','8',null,'19432987-3','1','d');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('63','2,5',null,'19432987-3','1','a');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('64','2,5',null,'19432987-3','1','b');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('65','0',null,'19432987-3','0','d');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('66','0',null,'19432987-3','0','a');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('67','0',null,'19432987-3','0','b');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('68','5',null,'19432987-3','1','c');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('69','3',null,'19432987-3','1','a');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('70','7',null,'19432987-3','1','b');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('71','0',null,'19432987-3','0','b');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('72','5',null,'19432987-3','1','d');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('73','0',null,'19432987-3','0','c');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('74','7,5',null,'19432987-3','1','d');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('75','0',null,'19432987-3','0','b');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('76','0',null,'19432987-3','0','c');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('77','7,5',null,'19432987-3','1','a');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('78','7,5',null,'19432987-3','1','b');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('79','0',null,'19432987-3','0','c');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('80','0',null,'19432987-3','0','c');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('81','0',null,'20457649-1','0','b');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('82','0',null,'20457649-1','0','c');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('83','0',null,'20457649-1','0','c');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('84','0',null,'20457649-1','0','c');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('85','0',null,'20457649-1','0','a');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('86','3',null,'20457649-1','1','d');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('87','5',null,'20457649-1','1','a');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('88','5',null,'20457649-1','1','c');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('89','3',null,'20457649-1','1','a');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('90','0',null,'20457649-1','0','c');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('91','0',null,'20457649-1','0','d');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('92','0',null,'20457649-1','0','a');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('93','0',null,'20457649-1','0','a');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('94','0',null,'20457649-1','0','a');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('95','7,5',null,'20457649-1','1','a');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('96','7,5',null,'20457649-1','1','b');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('97','7,5',null,'20457649-1','1','a');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('98','7,5',null,'20457649-1','1','b');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('99','0',null,'20457649-1','0','c');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('100','0',null,'20457649-1','0','a');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('101','0',null,'21902099-6','0','b');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('102','0',null,'21902099-6','0','b');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('103','2,5',null,'21902099-6','1','a');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('104','2,5',null,'21902099-6','1','b');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('105','2',null,'21902099-6','1','c');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('106','3',null,'21902099-6','1','d');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('107','5',null,'21902099-6','1','a');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('108','0',null,'21902099-6','0','d');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('109','0',null,'21902099-6','0','d');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('110','0',null,'21902099-6','0','d');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('111','5',null,'21902099-6','1','c');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('112','5',null,'21902099-6','1','d');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('113','7,5',null,'21902099-6','1','b');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('114','0',null,'21902099-6','0','a');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('115','0',null,'21902099-6','0','d');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('116','0',null,'21902099-6','0','d');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('117','0',null,'21902099-6','0','d');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('118','0',null,'21902099-6','0','d');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('119','6',null,'21902099-6','1','b');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('120','4',null,'21902099-6','1','d');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('121','2',null,'23747643-3','1','a');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('122','8',null,'23747643-3','1','d');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('123','2,5',null,'23747643-3','1','a');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('124','2,5',null,'23747643-3','1','b');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('125','0',null,'23747643-3','0','d');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('126','3',null,'23747643-3','1','d');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('127','0',null,'23747643-3','0','b');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('128','5',null,'23747643-3','1','c');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('129','0',null,'23747643-3','0','b');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('130','7',null,'23747643-3','1','b');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('131','5',null,'23747643-3','1','c');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('132','5',null,'23747643-3','1','d');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('133','0',null,'23747643-3','0','c');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('134','7,5',null,'23747643-3','1','d');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('135','0',null,'23747643-3','0','b');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('136','7,5',null,'23747643-3','1','b');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('137','0',null,'23747643-3','0','b');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('138','7,5',null,'23747643-3','1','b');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('139','0',null,'23747643-3','0','c');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('140','4',null,'23747643-3','1','d');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('141','0',null,'7333919-7','0','b');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('142','8',null,'7333919-7','1','d');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('143','2,5',null,'7333919-7','1','a');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('144','2,5',null,'7333919-7','1','b');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('145','2',null,'7333919-7','1','c');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('146','0',null,'7333919-7','0','b');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('147','0',null,'7333919-7','0','b');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('148','0',null,'7333919-7','0','b');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('149','0',null,'7333919-7','0','b');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('150','7',null,'7333919-7','1','b');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('151','5',null,'7333919-7','1','c');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('152','5',null,'7333919-7','1','d');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('153','0',null,'7333919-7','0','c');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('154','7,5',null,'7333919-7','1','d');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('155','0',null,'7333919-7','0','d');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('156','7,5',null,'7333919-7','1','b');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('157','0',null,'7333919-7','0','d');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('158','7,5',null,'7333919-7','1','b');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('159','0',null,'7333919-7','0','c');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('160','4',null,'7333919-7','1','d');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('161','0',null,'8820576-6','0','b');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('162','8',null,'8820576-6','1','d');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('163','0',null,'8820576-6','0','b');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('164','2,5',null,'8820576-6','1','b');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('165','0',null,'8820576-6','0','d');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('166','3',null,'8820576-6','1','d');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('167','5',null,'8820576-6','1','a');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('168','5',null,'8820576-6','1','c');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('169','3',null,'8820576-6','1','a');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('170','0',null,'8820576-6','0','c');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('171','0',null,'8820576-6','0','d');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('172','0',null,'8820576-6','0','b');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('173','0',null,'8820576-6','0','c');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('174','7,5',null,'8820576-6','1','d');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('175','7,5',null,'8820576-6','1','a');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('176','0',null,'8820576-6','0','c');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('177','7,5',null,'8820576-6','1','a');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('178','0',null,'8820576-6','0','d');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('179','6',null,'8820576-6','1','b');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('180','0',null,'8820576-6','0','c');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('181','0',null,'8927869-4','0','b');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('182','0',null,'8927869-4','0','b');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('183','2,5',null,'8927869-4','1','a');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('184','0',null,'8927869-4','0','c');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('185','2',null,'8927869-4','1','c');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('186','0',null,'8927869-4','0','c');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('187','5',null,'8927869-4','1','a');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('188','0',null,'8927869-4','0','a');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('189','3',null,'8927869-4','1','a');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('190','0',null,'8927869-4','0','a');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('191','5',null,'8927869-4','1','c');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('192','5',null,'8927869-4','1','d');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('193','7,5',null,'8927869-4','1','b');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('194','0',null,'8927869-4','0','c');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('195','0',null,'8927869-4','0','c');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('196','7,5',null,'8927869-4','1','b');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('197','0',null,'8927869-4','0','c');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('198','7,5',null,'8927869-4','1','b');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('199','0',null,'8927869-4','0','c');
Insert into SYSTEM.RESP (ID_RESP,PUNT_ALUMNO,PUNT_NORM,ALUMNO_RUT_ALUMNO,RESP_CORREG,RESPUESTA_ALUMNO) values ('200','4',null,'8927869-4','1','d');
REM INSERTING into SYSTEM.SQLPLUS_PRODUCT_PROFILE
SET DEFINE OFF;
REM INSERTING into SYSTEM.WAREHOUSES
SET DEFINE OFF;
--------------------------------------------------------
--  DDL for Index PK_INVENTORIES
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."PK_INVENTORIES" ON "SYSTEM"."INVENTORIES" ("PRODUCT_ID", "WAREHOUSE_ID") 
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."ALUMNO_PK" ON "SYSTEM"."ALUMNO" ("RUT_ALUMNO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index OPCION_RESP_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."OPCION_RESP_PK" ON "SYSTEM"."OPCION_RESP" ("OPCION_ID_ALT", "RESP_ID_RESP") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."OPCION_PK" ON "SYSTEM"."OPCION" ("ID_ALT") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."PRUEBA_PK" ON "SYSTEM"."PRUEBA" ("ID_TEST") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index CURSO_ALUMNO_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."CURSO_ALUMNO_PK" ON "SYSTEM"."CURSO_ALUMNO" ("ALUMNO_RUT_ALUMNO", "CURSO_ID_CURSO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."PK_ORDER_ITEMS" ON "SYSTEM"."ORDER_ITEMS" ("ORDER_ID", "ITEM_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."CURSO_PK" ON "SYSTEM"."CURSO" ("ID_CURSO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."RESP_PK" ON "SYSTEM"."RESP" ("ID_RESP") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index CURSO_TEST_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."CURSO_TEST_PK" ON "SYSTEM"."CURSO_TEST" ("CURSO_ID_CURSO", "TEST_ID_TEST") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."PREGUNTA_PK" ON "SYSTEM"."PREGUNTA" ("ID_PREG") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
--------------------------------------------------------
 ...
 (PARTITION "P_LESSTHAN100" 
  ...
  TABLESPACE "SYSAUX" ) ;
--------------------------------------------------------
--  DDL for Trigger AUTOIDCURSO
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "SYSTEM"."AUTOIDCURSO" 
before insert on curso
for each row
begin
  select idacurso.nextval into :new.id_curso from dual;
end;
/
ALTER TRIGGER "SYSTEM"."AUTOIDCURSO" ENABLE;
--------------------------------------------------------
--  DDL for Trigger AUTOIDTEST
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "SYSTEM"."AUTOIDTEST" 
before insert on prueba
for each row
begin
  select idaprueba.nextval into :new.id_test from dual;
end;
/
ALTER TRIGGER "SYSTEM"."AUTOIDTEST" ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."CURSO_ALUMNO" ADD CONSTRAINT "CURSO_ALUMNO_PK" PRIMARY KEY ("ALUMNO_RUT_ALUMNO", "CURSO_ID_CURSO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."CURSO_ALUMNO" MODIFY ("CURSO_ID_CURSO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CURSO_ALUMNO" MODIFY ("ALUMNO_RUT_ALUMNO" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table ALUMNO
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."ALUMNO" ADD CONSTRAINT "ALUMNO_PK" PRIMARY KEY ("RUT_ALUMNO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."ALUMNO" MODIFY ("RUT_ALUMNO" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."INVENTORIES" ADD CONSTRAINT "PK_INVENTORIES" PRIMARY KEY ("PRODUCT_ID", "WAREHOUSE_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."INVENTORIES" MODIFY ("QUANTITY" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."ORDER_ITEMS" ADD CONSTRAINT "PK_ORDER_ITEMS" PRIMARY KEY ("ORDER_ID", "ITEM_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."ORDER_ITEMS" MODIFY ("UNIT_PRICE" NOT NULL ENABLE);
...
--------------------------------------------------------
--  Constraints for Table CURSO_TEST
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."CURSO_TEST" ADD CONSTRAINT "CURSO_TEST_PK" PRIMARY KEY ("CURSO_ID_CURSO", "TEST_ID_TEST")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."CURSO_TEST" MODIFY ("TEST_ID_TEST" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CURSO_TEST" MODIFY ("CURSO_ID_CURSO" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."RESP" MODIFY ("RESP_CORREG" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."RESP" ADD CONSTRAINT "RESP_PK" PRIMARY KEY ("ID_RESP")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."RESP" MODIFY ("ALUMNO_RUT_ALUMNO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."RESP" MODIFY ("ID_RESP" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."OPCION" MODIFY ("ES_CORRECTO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."OPCION" ADD CONSTRAINT "OPCION_PK" PRIMARY KEY ("ID_ALT")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."OPCION" MODIFY ("PREGUNTA_ID_PREG" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."OPCION" MODIFY ("ID_ALT" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."WAREHOUSES" ADD PRIMARY KEY ("WAREHOUSE_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
...
--------------------------------------------------------
  ...
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."EMPLOYEES" MODIFY ("JOB_TITLE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."EMPLOYEES" MODIFY ("HIRE_DATE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."EMPLOYEES" MODIFY ("PHONE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."EMPLOYEES" MODIFY ("EMAIL" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."EMPLOYEES" MODIFY ("LAST_NAME" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."EMPLOYEES" MODIFY ("FIRST_NAME" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."PRUEBA" ADD CONSTRAINT "PRUEBA_PK" PRIMARY KEY ("ID_TEST")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."PRUEBA" MODIFY ("CURSO_ID_CURSO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PRUEBA" MODIFY ("ID_TEST" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."CURSO" ADD CONSTRAINT "CURSO_PK" PRIMARY KEY ("ID_CURSO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."CURSO" MODIFY ("NOMBRE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CURSO" MODIFY ("ID_CURSO" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."LOCATIONS" MODIFY ("ADDRESS" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."REGIONS" MODIFY ("REGION_NAME" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
--  Constraints for Table CURSO_PRUEBA
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."CURSO_PRUEBA" MODIFY ("TEST_ID_TEST" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CURSO_PRUEBA" MODIFY ("CURSO_ID_CURSO" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table CONTACTS
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."CONTACTS" ADD PRIMARY KEY ("CONTACT_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."CONTACTS" MODIFY ("EMAIL" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CONTACTS" MODIFY ("LAST_NAME" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CONTACTS" MODIFY ("FIRST_NAME" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table OPCION_RESP
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."OPCION_RESP" ADD CONSTRAINT "OPCION_RESP_PK" PRIMARY KEY ("OPCION_ID_ALT", "RESP_ID_RESP")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."OPCION_RESP" MODIFY ("RESP_ID_RESP" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."OPCION_RESP" MODIFY ("OPCION_ID_ALT" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."PREGUNTA" ADD CONSTRAINT "PREGUNTA_PK" PRIMARY KEY ("ID_PREG")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."PREGUNTA" MODIFY ("PRUEBA_ID_TEST" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PREGUNTA" MODIFY ("ID_PREG" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."CONTACTS" ADD CONSTRAINT "FK_CONTACTS_CUSTOMERS" FOREIGN KEY ("CUSTOMER_ID")
	  REFERENCES "SYSTEM"."CUSTOMERS" ("CUSTOMER_ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table COUNTRIES
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."COUNTRIES" ADD CONSTRAINT "FK_COUNTRIES_REGIONS" FOREIGN KEY ("REGION_ID")
	  REFERENCES "SYSTEM"."REGIONS" ("REGION_ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table CURSO_ALUMNO
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."CURSO_ALUMNO" ADD CONSTRAINT "CURSO_ALUMNO_ALUMNO_FK" FOREIGN KEY ("ALUMNO_RUT_ALUMNO")
	  REFERENCES "SYSTEM"."ALUMNO" ("RUT_ALUMNO") ENABLE;
  ALTER TABLE "SYSTEM"."CURSO_ALUMNO" ADD CONSTRAINT "CURSO_ALUMNO_CURSO_FK" FOREIGN KEY ("CURSO_ID_CURSO")
	  REFERENCES "SYSTEM"."CURSO" ("ID_CURSO") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table CURSO_TEST
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."CURSO_TEST" ADD CONSTRAINT "CURSO_TEST_CURSO_FK" FOREIGN KEY ("CURSO_ID_CURSO")
	  REFERENCES "SYSTEM"."CURSO" ("ID_CURSO") ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."EMPLOYEES" ADD CONSTRAINT "FK_EMPLOYEES_MANAGER" FOREIGN KEY ("MANAGER_ID")
	  REFERENCES "SYSTEM"."EMPLOYEES" ("EMPLOYEE_ID") ON DELETE CASCADE DISABLE;
--------------------------------------------------------
--  Ref Constraints for Table INVENTORIES
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."INVENTORIES" ADD CONSTRAINT "FK_INVENTORIES_PRODUCTS" FOREIGN KEY ("PRODUCT_ID")
	  REFERENCES "SYSTEM"."PRODUCTS" ("PRODUCT_ID") ON DELETE CASCADE ENABLE;
  ALTER TABLE "SYSTEM"."INVENTORIES" ADD CONSTRAINT "FK_INVENTORIES_WAREHOUSES" FOREIGN KEY ("WAREHOUSE_ID")
	  REFERENCES "SYSTEM"."WAREHOUSES" ("WAREHOUSE_ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table LOCATIONS
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."LOCATIONS" ADD CONSTRAINT "FK_LOCATIONS_COUNTRIES" FOREIGN KEY ("COUNTRY_ID")
	  REFERENCES "SYSTEM"."COUNTRIES" ("COUNTRY_ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."OPCION" ADD CONSTRAINT "OPCION_PREGUNTA_FK" FOREIGN KEY ("PREGUNTA_ID_PREG")
	  REFERENCES "SYSTEM"."PREGUNTA" ("ID_PREG") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table OPCION_RESP
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."OPCION_RESP" ADD CONSTRAINT "OPCION_RESP_OPCION_FK" FOREIGN KEY ("OPCION_ID_ALT")
	  REFERENCES "SYSTEM"."OPCION" ("ID_ALT") ENABLE;
  ALTER TABLE "SYSTEM"."OPCION_RESP" ADD CONSTRAINT "OPCION_RESP_RESP_FK" FOREIGN KEY ("RESP_ID_RESP")
	  REFERENCES "SYSTEM"."RESP" ("ID_RESP") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table ORDER_ITEMS
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."ORDER_ITEMS" ADD CONSTRAINT "FK_ORDER_ITEMS_ORDERS" FOREIGN KEY ("ORDER_ID")
	  REFERENCES "SYSTEM"."ORDERS" ("ORDER_ID") ON DELETE CASCADE ENABLE;
  ALTER TABLE "SYSTEM"."ORDER_ITEMS" ADD CONSTRAINT "FK_ORDER_ITEMS_PRODUCTS" FOREIGN KEY ("PRODUCT_ID")
	  REFERENCES "SYSTEM"."PRODUCTS" ("PRODUCT_ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table ORDERS
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."ORDERS" ADD CONSTRAINT "FK_ORDERS_CUSTOMERS" FOREIGN KEY ("CUSTOMER_ID")
	  REFERENCES "SYSTEM"."CUSTOMERS" ("CUSTOMER_ID") ON DELETE CASCADE ENABLE;
  ALTER TABLE "SYSTEM"."ORDERS" ADD CONSTRAINT "FK_ORDERS_EMPLOYEES" FOREIGN KEY ("SALESMAN_ID")
	  REFERENCES "SYSTEM"."EMPLOYEES" ("EMPLOYEE_ID") ON DELETE SET NULL ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table PREGUNTA
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."PREGUNTA" ADD CONSTRAINT "PREGUNTA_PRUEBA_FK" FOREIGN KEY ("PRUEBA_ID_TEST")
	  REFERENCES "SYSTEM"."PRUEBA" ("ID_TEST") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table PRODUCTS
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."PRODUCTS" ADD CONSTRAINT "FK_PRODUCTS_CATEGORIES" FOREIGN KEY ("CATEGORY_ID")
	  REFERENCES "SYSTEM"."PRODUCT_CATEGORIES" ("CATEGORY_ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table PRUEBA
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."PRUEBA" ADD CONSTRAINT "PRUEBA_CURSO_FK" FOREIGN KEY ("CURSO_ID_CURSO")
	  REFERENCES "SYSTEM"."CURSO" ("ID_CURSO") ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."RESP" ADD CONSTRAINT "RESP_ALUMNO_FK" FOREIGN KEY ("ALUMNO_RUT_ALUMNO")
	  REFERENCES "SYSTEM"."ALUMNO" ("RUT_ALUMNO") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table WAREHOUSES
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."WAREHOUSES" ADD CONSTRAINT "FK_WAREHOUSES_LOCATIONS" FOREIGN KEY ("LOCATION_ID")
	  REFERENCES "SYSTEM"."LOCATIONS" ("LOCATION_ID") ON DELETE CASCADE ENABLE;
